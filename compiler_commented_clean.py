...
#I completed this assingment alone, although I used some stuff to get brainfart syntax info, I believe http://esolangs.org/wiki/brainfart was used to some degree.

#To help you out, a heavily commented version


#------------------------------------------------------------------------------
#a fully functional compiler for brainfart written in vanilla python
...
def interpreter():
    ...
    print("""Welcome to brainfart, this compiler will eventually do some cool things, 
...
\nJosh Morton """)
    ...
    """ This is the interpreted mode for this command line brainfart compiler.  
    In case you are unaware, these are the brainfart commands:
